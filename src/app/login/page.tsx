...
export default function LoginPage() {
  ...
  async function handleGoogleSignInAsPembimbing() {
    await doGoogleSignIn("pembimbing")
  }

  async function doGoogleSignIn(role?: string) {
            ...
            {forgotMode ? (
              ...
              <form onSubmit={handleSubmit} className={styles.form}>
                ...
                >
                  ...
                  {googleLoading ? "Memproses..." : "Lanjutkan dengan Google (Siswa)"}
                </button>

                <button type="button" onClick={handleGoogleSignInAsPembimbing} disabled={googleLoading}
                  style={{
                    width: "100%", display: "flex", alignItems: "center", justifyContent: "center", gap: "10px",
                    padding: "10px 16px", borderRadius: "12px", border: "1px solid var(--color-outline)",
                    background: "var(--bg-card)", fontSize: "0.875rem", fontWeight: 600, color: "var(--color-ink)",
                ...
                >
                  ...
                  {googleLoading ? "Memproses..." : "Lanjutkan dengan Google (Pembimbing)"}
                </button>
              </form>
            )}
